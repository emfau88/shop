...
const phases = [
  ...
  },
  {
    ...
    facts: ['Mulden und Retentionsflächen', 'Wegeschleife zum Sitzplatz', 'Schatten durch Gehölze'],
    image: 'plan',
  },
  {
    id: 'umsetzung',
    ...
    facts: ['Naturstein · Holz · Kies', 'Durchlässiger Unterbau', 'Saubere Kantenführung'],
  ...
  },
  {
    ...
    facts: ['Regenwasser im Garten', 'Sitzplatz im Schatten', 'Planung und Ausführung'],
    image: 'garten',
  },
] as const;
...
export function LandscapeProjectJourney() {
  ...
  return (
    <section className="landscape-journey" aria-labelledby="garden-journey-title">
      ...
      <div className="landscape-wrap landscape-journey-tabs" role="tablist" aria-label="Projektphasen">
      ...
      >
        <div className="landscape-journey-visual">
          {phase.image === 'plan' ? (
            <svg viewBox="0 0 800 560" aria-label="Reduzierter Entwurfsplan für Garten 07">
              <path className="landscape-plan-boundary" d="M80 89 689 64 739 465 120 501Z" />
              <path className="landscape-plan-house" d="M104 119 315 109 330 255 121 270Z" />
              <path className="landscape-plan-path" d="M317 280C415 250 478 160 659 153M317 280c87 19 94 143 250 151M350 328c63-20 139 8 179 58" />
              <path className="landscape-plan-water" d="M364 376c70-57 188-38 240 30-84 45-180 47-240-30Z" />
              <circle className="landscape-plan-tree" cx="576" cy="215" r="47" />
              <circle className="landscape-plan-tree" cx="664" cy="330" r="58" />
              <text x="128" y="160">HAUS</text><text x="427" y="184">WEG</text><text x="426" y="421">MULDE</text>
            </svg>
          ) : (
            <LandscapePhoto
              name={phase.image}
        ...
        <div className="landscape-journey-copy">
          ...
          <p>{phase.text}</p>
          <ul>
            {phase.facts.map((fact) => <li key={fact}>{fact}</li>)}
          </ul>
        </div>
      </div>
    </section>
